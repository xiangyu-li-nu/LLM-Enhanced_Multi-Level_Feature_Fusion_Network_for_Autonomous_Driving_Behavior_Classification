...
# 10. Define multimodal model (numerical feature branch uses multi-scale convolution with spatio-temporal attention)
class MultiModalClassifier(nn.Module):
    def __init__(self, num_numerical_features, num_labels, roberta_model_name='roberta-base'):
        ...
        # Numerical feature branch: multi-scale 1D convolution + spatio-temporal attention + deeper convolution network
        ...
        # Fully connected layers to process the features from the convolution
        ...
        # Add a linear layer to map text features from 768 to 128
    ...
    def forward(self, input_ids, attention_mask, numerical):
        ...
        # Feature fusion (concatenate directly)
...
print("Model has been saved as 'enhanced_multi_modal_roberta_classifier.pth'")
